  ...
  return (
    <div className="slideshow">
      <figure>
        ...
        <figcaption>
          <h3>Anime Encuesta</h3>
          <div className="row open-sans-font">
            <div className="col-12 col-sm-6 mb-2">
              <i className="fa fa-file-text-o pr-2"></i>
              <span className="project-label">Proyecto</span>:{" "}
              <span className="ft-wt-600 uppercase">Anime Encuesta</span>
            </div>
            {/* End .col */}
            ...
            <div className="col-12 col-sm-6 mb-2">
              ...
              <span className="ft-wt-600 uppercase">HTML, CSS, Javascript, React, Sockte.io</span>
            </div>
            {/* End .col */}
            ...
            <div className="col-12 col-sm-6 mb-2">
              ...
              <span className="ft-wt-600 uppercase">
                <a
                  href="https://andres-anime-encuesta.herokuapp.com/"
                  target="_blank"
                  rel="noreferrer"
                >
                  andres-anime-encuesta.herokuapp.com
                </a>
              </span>
            </div>
            {/* End .col */}
